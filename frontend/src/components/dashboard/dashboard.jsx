...
const Dashboard = () => {
  ...
  return (
    <>
    {loading ? (
      <h4 style={{display: 'flex',alignItems: 'center',justifyContent: 'center',fontFamily: 'Montserrat',height: '100%'}}>Loading</h4>
    ):(      
                    ...
                    <div className="analytics">
                      <div className="analytics-data">
                        ...
                        <div className="analytics-data-score">
                          <p className='score-1'>{medData.takenMeds ? medData?.takenMeds : 0}</p>
                          <p className='score-total'>/{medData.totalMeds ? medData?.totalMeds : 0}</p>
                        </div>
                      ...
                      <div className="analytics-data">
                        ...
                        <div className="analytics-data-score">
                          <p className='score-1'>{medData.missedMeds? medData?.missedMeds : 0}</p>
                          <p className='score-total'>/{medData.totalMeds ? medData?.totalMeds : 0}</p>
                        </div>
                      ...
                      <div className="adherence-container">
                        <div className="circle">
                          <div className="circle-text">
                            <p className="number">{medData.percentageAdherence ?medData?.percentageAdherence: 0 }</p>
